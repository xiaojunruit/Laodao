 ...
 */
package com.laoodao.smartagri.view.recyclerview;
...
import com.laoodao.smartagri.view.recyclerview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mErrorId = a.getResourceId(R.styleable.superrecyclerview_layout_error, R.layout._widget_net_error_view);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout._widget_recyclerview, this);
     ...
     * @param paddingRight
     */
    public void setItemDecoration(int color, int height, int paddingLeft, int paddingRight,int fistMargin) {
        DividerDecoration itemDecoration = new DividerDecoration(color, height, paddingLeft, paddingRight);
        itemDecoration.setDrawLastItem(false);
        itemDecoration.setFistMargin(fistMargin);
        decorations.add(itemDecoration);
        mRecycler.addItemDecoration(itemDecoration);
    }
