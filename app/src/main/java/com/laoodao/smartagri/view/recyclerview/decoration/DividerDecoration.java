 ...
 */
package com.laoodao.smartagri.view.recyclerview.decoration;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position >= headerCount && position < parent.getAdapter().getItemCount() - footerCount || mDrawHeaderFooter) {
            if (orientation == OrientationHelper.VERTICAL) {
                ...
                if (parent.getAdapter().getItemCount() > 1 && position != (parent.getAdapter().getItemCount() - footerCount - headerCount) - 1) {
