...
//        String finalProgressDesc = mProgressDesc + " " + mProgress + "/" + mMax;
        String finalProgressDesc = mProgress + mProgressDesc;
    ...
    public void setCurProgress(final int progress) {
        ...
        ObjectAnimator mAnimator = ObjectAnimator.ofInt(this, "progress", progress).setDuration(1500);
