...
public class BrowseBuyPresenter extends ListPresenter<BrowseBuyContact.BrowseBuyView> implements BrowseBuyContact.Presenter<BrowseBuyContact.BrowseBuyView> {
    ServiceManager mServiceManager;

    @Inject
    public BrowseBuyPresenter(ServiceManager serviceManager) {
    ...
    public void requestData(int page, int type) {
        ...
        if (page == 1) {
            String key = Constant.BROWSE_BUY + page;
