...
public class QueryFertilizerAdapter extends BaseAdapter<TruthQuery> {


    public QueryFertilizerAdapter(Context context) {
        super(context);
    }
    ...
    class QueryResultHolder extends BaseViewHolder<TruthQuery> {
        ...
        public void setData(TruthQuery data) {
            ...
            itemView.setOnClickListener(v -> {
                FertilizerDetailActivity.start(getContext(), data.id);
            });
        }
    }
}
