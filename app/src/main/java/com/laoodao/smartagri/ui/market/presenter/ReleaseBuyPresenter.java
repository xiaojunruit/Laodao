...
public class ReleaseBuyPresenter extends ListPresenter<ReleaseBuyContact.ReleaseBuyView> implements ReleaseBuyContact.Presenter<ReleaseBuyContact.ReleaseBuyView> {
    ServiceManager mServiceManager;

    @Inject
    public ReleaseBuyPresenter(ServiceManager serviceManager) {
