package com.ejz.multistateview;
...
public class MultiStateView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mLoadingViewResId = a.getResourceId(R.styleable.MultiStateView_msv_loadingView, R.layout.loading_view);

        mEmptyViewResId = a.getResourceId(R.styleable.MultiStateView_msv_emptyView, R.layout.empty_view);

        mErrorViewResId = a.getResourceId(R.styleable.MultiStateView_msv_errorView, R.layout.error_view);
